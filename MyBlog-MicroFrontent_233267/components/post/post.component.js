...
export class Post extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.#render(shadow);
        this.#consultaPosts(postId, shadow);
    }
    ...
    #agregarEstilo(shadow) {
        ...
        link.setAttribute("href", "../components/post/post.component.css");
        shadow.appendChild(link);
    }

    #consultaPosts(postId, shadow) {
        this.#postService.obtenerPost(postId)
            .then(post => {
                ...
                this.#consultaUsuario(post.userId, shadow);
            })
    }

    #consultaUsuario(userId, shadow) {
