...
export class Comments extends HTMLElement {
    ...
    #render(shadow) {
        shadow.innerHTML += `
            <details>
                <summary class="date">
                    <img src="../gifts/comment.gif" alt="comment.gif" />
    ...
    #agregarEstilo(shadow) {
        ...
        link.setAttribute("href", "../components/comment/comments.component.css");
    ...
    #consultarComentarios(postId, shadow) {
        this.#postService.obtenerComentarios(postId)
            .then(comments => {
                ...
                comments.forEach(comment => this.#despliegaComentario(tmp, div, comment));
            })
    }
